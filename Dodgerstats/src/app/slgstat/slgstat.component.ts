...
@Component({
  selector: 'slg-stat',
  templateUrl: './slgstat.component.html',
  styleUrls: ['./slgstat.component.css']
})
export class SlgstatComponent implements OnInit {
