...
export class StatComponent implements OnInit {
  ...
  OnClickFunc(parameter:string){
    let url:string = "https://google.com/search=?q" + parameter; 
    return url;
  }
