...
@Component({
  selector: 'sb-stat',
  templateUrl: './sbstat.component.html',
  styleUrls: ['./sbstat.component.css']
})
export class SbStatComponent implements OnInit {
